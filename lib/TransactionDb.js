...
var encodedData = require('soop').load('clamcore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('clamcore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('clamcore/lib/Address', {
